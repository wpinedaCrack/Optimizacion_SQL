/*1.Utilizar Compresion de Datos por Fila*/
...
--CREATE nonCLUSTERED  INDEX IX_TBLVENTAS_DETALLE_ID ON TBLVENTAS_DETALLE(ID) INCLUDE(CANTIDAD,VALOR) WITH(DATA_COMPRESSION=ROW)  ---NIVEL DE FILA
--CREATE nonCLUSTERED  INDEX IX_TBLVENTAS_DETALLE_ID ON TBLVENTAS_DETALLE(ID) INCLUDE(CANTIDAD,VALOR) WITH(DATA_COMPRESSION=PAGE) ---NIVEL DE PAGINA
