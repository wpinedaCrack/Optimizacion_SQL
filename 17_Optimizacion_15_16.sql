/*1.Practica General de Indices
      RECORDATORIO DE INDICES
1.CREATE INDEX INCLUDE WITH (FILLFACTOR)  EN TODAS LA EDICIONES
2.CREATE INDEX INCLUDE WITH (DATACOMPRESSION)  ENTREPRISE Y DEVELOPER
3.CREATE CLUSTERED/NONCLUSTERED COLUMNSTORE INDEX ENTREPRISE Y DEVELOPER*/
